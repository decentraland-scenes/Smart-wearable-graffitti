...
export function addUI() {
  const uiHint = new ui.SmallIcon('assets/icon.png', -50, 350, 50, 50, {
    sourceWidth: 256,
    sourceHeight: 256
  })
...
const graffitiUi = new ui.CustomPrompt(
...
const chb1 = graffitiUi.addButton('Default1', 0, 100, () => {
  setExistingGraffiti(0)
  graffitiUi.hide()
})
const chb2 = graffitiUi.addButton('Default2', 0, 30, () => {
  setExistingGraffiti(1)
  graffitiUi.hide()
})

const URLMenuButton = graffitiUi.addButton('From URL', 0, -40, () => {
  chb1.hide()
  chb2.hide()
  URLMenuButton.hide()
  NFTMenuButton.hide()

  const URLText = graffitiUi.addTextBox(0, 50, 'Image URL', (e: any) => {
    currentURLText = e
  })
  URLText.fillInBox.textWrapping = true
  let currentURLText = ''
  const URLButton = graffitiUi.addButton('Set URL', 0, -50, () => {
...
const NFTMenuButton = graffitiUi.addButton('From NFT', 0, -100, () => {
  chb1.hide()
  chb2.hide()
  URLMenuButton.hide()
  NFTMenuButton.hide()

  const NFTText1 = graffitiUi.addTextBox(0, 50, 'NFT contract', (e: any) => {
    currentNFTText1 = e
  })

  const NFTText2 = graffitiUi.addTextBox(0, -30, 'NFT id', (e: any) => {
    currentNFTText2 = e
  })
  ...
  let currentNFTText1 = ''
  let currentNFTText2 = ''
  const NFTButton = graffitiUi.addButton('Set NFT', 0, -110, () => {
